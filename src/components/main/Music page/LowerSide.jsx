      ...
      <div className="w-full h-[10vh] items-center flex px-5 justify-between">
        <div className="flex items-center pl-5">
          ...
          <div className="text-white flex flex-col items-start ml-5  max-w-[15vw] min-w-[15vw]">
            <div className="truncate  max-w-[15vw] min-w-[15vw] font-bold text-base">
              {currentSong?.name}
            </div>
            <div className="truncate  max-w-[15vw] min-w-[15vw] ">
              {current?.artist?.map((art, index) => (
                <NavLink key={index}>
                  {art?.name}
        ...
        <div className="flex items-center gap-x-5">
          ...
          >
            {isPlaying ? (
              <FaPause
                className="icon-transition icon-pause"
                color="white"
                size={25}
              />
            ) : (
              <FaPlay
                className="icon-transition icon-play"
                color="white"
                size={25}
              />
            )}
        ...
        <div className="flex  items-center  gap-x-2 ">
          ...
          <div
            className={`${
              isLooping ? "bg-[#476652]" : "hover:bg-[#3a3a3a]"
          ...
          <div
            onClick={changeArrow}
            className="  hover:bg-gray-600 items-center justify-center flex rounded-[50%] p-[0.2%]"
          >
            {arrow == "up" ? (
              <IoMdArrowDropup size={24} color="white" />
            ) : (
